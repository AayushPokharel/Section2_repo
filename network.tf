...
resource "azurerm_network_security_group" "web" {
  ...
  security_rule {
    ...
    source_address_prefix      = var.mgmt_source_cidr
    destination_address_prefix = "*"
  }
}

# Data-tier NSG: SQL (1433) and RDP (3389) only from the web subnet, everything else denied.
# NOTE: RDP-from-web is for the connectivity demo in Step 12; in production, front it with Azure Bastion.
